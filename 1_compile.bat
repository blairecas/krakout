...
..\scripts\rt11dsk.exe d .\release\krkout.dsk krk.sav >NUL
..\scripts\rt11dsk.exe a .\release\krkout.dsk .\release\krk.sav >NUL

..\scripts\rt11dsk.exe d ..\..\03_dsk\hdd.dsk krk.sav >NUL
